...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForRuleCollection() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("Rules.Excel", "RuleCollection", 0x8c4b72ae776424aL, 0xb5c9f314339ec802L, 0x5bf776a602542535L);
    b.class_(false, false, false);
    b.parent(0x17e7b90aaaca44c7L, 0xaaaa8155bb498bd7L, 0x7e19241b9e5efb81L);
    b.parent(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L);
    b.origin("r:07449f7e-067e-4ea6-bb7e-08ed9222f696(Rules.Excel.structure)/6626895832074691893");
    b.version(2);
    b.aggregate("rules", 0x5bf776a602542538L).target(0x17e7b90aaaca44c7L, 0xaaaa8155bb498bd7L, 0x7e19241b9e61793cL).optional(true).ordered(true).multiple(true).origin("6626895832074691896").done();
    return b.create();
  }
}

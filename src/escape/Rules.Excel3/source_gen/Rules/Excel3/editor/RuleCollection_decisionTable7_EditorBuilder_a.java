...
/*package*/ class RuleCollection_decisionTable7_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RuleCollection_decisionTable7_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_s42jhd_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_s42jhd_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_s42jhd_a0a");
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_s42jhd_a1a(editorContext, node);
              ...
              editorCell.value.setCellId("Table_s42jhd_b0");
  ...
  public Grid createChildsVertical_s42jhd_a1a(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

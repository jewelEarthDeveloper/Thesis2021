...
/*package*/ class ec_ruleTablePart7_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ec_ruleTablePart7_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticHorizontal_36o78p_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_36o78p_a");
      editorCell.init();
      return editorCell;
  ...
  public Grid createStaticHorizontal_36o78p_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

    List<Grid> children = new ArrayList<Grid>(3);
    if (true) {
      children.add(createTableCell_36o78p_a0a(editorContext, node));
    }
    if (true) {
      children.add(createGridQuery_36o78p_b0a(editorContext, node));
    }
    if (true) {
      children.add(createTableCell_36o78p_c0a(editorContext, node));
    }
  ...
  public Grid createTableCell_36o78p_a0a(final EditorContext editorContext, final SNode node) {
    ...
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
        style.set(StyleAttributes.getInstance().<Color>getAttribute("de.slisson.mps.tables", "shade-color"), _StyleParameter_QueryFunction_36o78p_a0a0a0());
        return style;
      }
    }.createStyle(0, 0);
    ...
    grid.setColumnHeaders(0, 0, createEditorCellHeader_36o78p_a0a0(editorContext, node));
  ...
  public HeaderGrid createEditorCellHeader_36o78p_a0a0(final EditorContext editorContext, final SNode node) {
    ...
    Header header = new EditorCellHeader(new StringHeaderReference("4593171954175898611"), cell);
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_36o78p_a0a0a");
    Style style = new StyleImpl();
  ...
  private Color _StyleParameter_QueryFunction_36o78p_a0a0a0() {
    return ((getNode() == null) ? new Color(228, 233, 237) : new Color(228, 233, 237));
  }
  public Grid createGridQuery_36o78p_b0a(final EditorContext editorContext, final SNode node) {
  ...
  public Grid createTableCell_36o78p_c0a(final EditorContext editorContext, final SNode node) {
    ...
    grid.setColumnHeaders(0, 0, createStaticHeader_36o78p_a2a0(editorContext, node));

    return grid;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new outcomesSingleRoleHandler_36o78p_a2a0(myNode, LINKS.outcomes$4s7, getEditorContext());
    return provider.createCell();
  }
  private static class outcomesSingleRoleHandler_36o78p_a2a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public outcomesSingleRoleHandler_36o78p_a2a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  public HeaderGrid createStaticHeader_36o78p_a2a0(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;

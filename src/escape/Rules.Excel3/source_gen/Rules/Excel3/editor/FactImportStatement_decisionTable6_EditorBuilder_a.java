...
/*package*/ class FactImportStatement_decisionTable6_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FactImportStatement_decisionTable6_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_upse37_a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeSingleRoleHandler_upse37_a0(myNode, LINKS.type$kzl2, getEditorContext());
    return provider.createCell();
  }
  private static class typeSingleRoleHandler_upse37_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeSingleRoleHandler_upse37_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {

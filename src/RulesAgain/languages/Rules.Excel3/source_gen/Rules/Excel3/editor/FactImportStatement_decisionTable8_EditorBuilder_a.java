...
/*package*/ class FactImportStatement_decisionTable8_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FactImportStatement_decisionTable8_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_o0uu5u_a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeSingleRoleHandler_o0uu5u_a0(myNode, LINKS.type$kzl2, getEditorContext());
    return provider.createCell();
  }
  private static class typeSingleRoleHandler_o0uu5u_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeSingleRoleHandler_o0uu5u_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {

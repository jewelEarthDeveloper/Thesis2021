...
/*package*/ class RuleStatement_decisionTable3_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    ...
    Style style = new StyleImpl();
    style.set(StyleAttributes.getInstance().<HorizontalAlignment>getAttribute("de.slisson.mps.tables", "horizontal-alignment"), _StyleParameter_QueryFunction_p1in3j_a0a0a0a());
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
  private HorizontalAlignment _StyleParameter_QueryFunction_p1in3j_a0a0a0a() {
    ...
    new Object() {
      public void fillGrid(final ITableGrid grid, final SNode node, final SubstituteInfoFactory substituteInfoFactory) {
        ...
        for (final SNode fact : Sequence.fromIterable(facts)) {
          ...
          if ((selector == null)) {
            grid.getCell(x, 0).getStyle().set(StyleAttributes.getInstance().<Color>getAttribute("de.slisson.mps.tables", "shade-color"), Color.LIGHT_GRAY);
          }
  ...
  public Grid createTableCell_p1in3j_c0a(final EditorContext editorContext, final SNode node) {
    ...
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
        style.set(StyleAttributes.getInstance().<HorizontalAlignment>getAttribute("de.slisson.mps.tables", "horizontal-alignment"), _StyleParameter_QueryFunction_p1in3j_a0a2a0());
        return style;
      }
    }.createStyle(0, 0);
  ...
  private HorizontalAlignment _StyleParameter_QueryFunction_p1in3j_a0a2a0() {
    return HorizontalAlignment.CENTER;
  }

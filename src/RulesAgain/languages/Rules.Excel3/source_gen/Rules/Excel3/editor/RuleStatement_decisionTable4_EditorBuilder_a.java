...
/*package*/ class RuleStatement_decisionTable4_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RuleStatement_decisionTable4_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticHorizontal_3xrun3_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_3xrun3_a");
  ...
  public Grid createStaticHorizontal_3xrun3_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

    List<Grid> children = new ArrayList<Grid>(3);
    if (true) {
      children.add(createTableCell_3xrun3_a0a(editorContext, node));
    }
    if (true) {
      children.add(createGridQuery_3xrun3_b0a(editorContext, node));
    }
    if (true) {
      children.add(createTableCell_3xrun3_c0a(editorContext, node));
    }
  ...
  public Grid createTableCell_3xrun3_a0a(final EditorContext editorContext, final SNode node) {
    ...
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
        style.set(StyleAttributes.getInstance().<Color>getAttribute("de.slisson.mps.tables", "shade-color"), _StyleParameter_QueryFunction_3xrun3_a0a0a0());
        return style;
      }
    }.createStyle(0, 0);
    ...
    grid.setColumnHeaders(0, 0, createEditorCellHeader_3xrun3_a0a0(editorContext, node));
  ...
  public HeaderGrid createEditorCellHeader_3xrun3_a0a0(final EditorContext editorContext, final SNode node) {
    ...
    Header header = new EditorCellHeader(new StringHeaderReference("7282003193077293545"), cell);
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_3xrun3_a0a0a");
    Style style = new StyleImpl();
  ...
  private Color _StyleParameter_QueryFunction_3xrun3_a0a0a0() {
    return ((getNode() == null) ? new Color(228, 233, 237) : new Color(228, 233, 237));
  }
  public Grid createGridQuery_3xrun3_b0a(final EditorContext editorContext, final SNode node) {
    ...
    new Object() {
      public void fillGrid(final ITableGrid grid, final SNode node, final SubstituteInfoFactory substituteInfoFactory) {
        ...
        Iterable<SNode> existProps = RuleCollection__BehaviorDescriptor.factsWithNoRestrictions_id6keRPa8QCMN.invoke(SNodeOperations.getNodeAncestor(node, CONCEPTS.RuleCollection$jd, false, false));

        Iterable<SNode> props = RuleCollection__BehaviorDescriptor.propertiesInCollection_id6keRPa8DhEy.invoke(SNodeOperations.getNodeAncestor(node, CONCEPTS.RuleCollection$jd, false, false));

        // grid should allow more than one restriction 
        grid.setSize(Sequence.fromIterable(props).count() + Sequence.fromIterable(existProps).count(), 1);
        ...
        for (final SNode fact : Sequence.fromIterable(facts)) {
          ...
          grid.setColumnHeader(ColNr, factRow, Sequence.fromIterable(propsInFact).count() + ((Sequence.fromIterable(existProps).contains(fact) ? 1 : 0)), 1, fact);
          ...
          if (Sequence.fromIterable(existProps).contains(fact)) {
            if (Sequence.fromIterable(selectorsOfFact).where(new IWhereFilter<SNode>() {
              public boolean accept(SNode it) {
                return Objects.equals(ListSequence.fromList(SLinkOperations.getChildren(it, LINKS.constraints$YjI3)).count(), 0);
              }
            }).count() > 0) {
              grid.setCell(ColNr, 0, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x993797d3830647edL, 0xba6d94925225abc2L, 0x650edf5288ddd983L, "Rules.Excel3.structure.FactExists")));
            }
            grid.setColumnHeader(ColNr, propRow, "exists");
            ColNr++;
          }
  ...
  public Grid createTableCell_3xrun3_c0a(final EditorContext editorContext, final SNode node) {
    ...
    grid.setColumnHeaders(0, 0, createStaticHeader_3xrun3_a2a0(editorContext, node));

    return grid;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new outcomesSingleRoleHandler_3xrun3_a2a0(myNode, LINKS.outcomes$4s7, getEditorContext());
    return provider.createCell();
  }
  private static class outcomesSingleRoleHandler_3xrun3_a2a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public outcomesSingleRoleHandler_3xrun3_a2a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  public HeaderGrid createStaticHeader_3xrun3_a2a0(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;

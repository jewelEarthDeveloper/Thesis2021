...
public class ExistsCondition_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Wrap_t1ry64_a(), CONCEPTS.ExistsCondition$i9));
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for " + "ExistsCondition", new SNodePointer("r:1150d448-f221-444c-8400-1c42091f6f14(Rules3.editor)", "9086333424237758569")));
    try {
  ...
  private class SMP_Wrap_t1ry64_a extends WrapperSubstituteMenuPart {
    ...
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "FactImportedRef", new SNodePointer("r:1150d448-f221-444c-8400-1c42091f6f14(Rules3.editor)", "8484003412859696831")));
      try {
    ...
    protected SubstituteMenuItem wrapItem(final SubstituteMenuItem item, final SubstituteMenuContext _context) {
      ...
      return new SubstituteMenuItemWrapper(item) {
        ...
        public SAbstractConcept getOutputConcept() {
          return CONCEPTS.ExistsCondition$i9;
        }
        @Nullable
        @Override
        public SNode createNode(@NotNull String pattern) {
          ...
          SLinkOperations.setTarget(selector, LINKS.fact$id2P, nodeToWrap);

          SNode existsNode = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xfd191ffbab394c9cL, 0xb211e8ff05fd03b0L, 0x47aa13e870db4d38L, "Rules3.structure.ExistsCondition"));
          SLinkOperations.setTarget(existsNode, LINKS.selector$9bkx, selector);
    ...
    private SAbstractConcept getConceptToFindMenuFor(SubstituteMenuContext _context) {
      return CONCEPTS.FactImportedRef$X4;
    }
  }

...
public class FactProperty_Constraints extends BaseConstraintsDescriptor {
  public FactProperty_Constraints() {
    super(CONCEPTS.FactProperty$A1);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.property$rsy0, this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_75aht8_a0a0a0a0a1a0a0a0c;
          }
          @Override
          public Scope createScope(final ReferenceConstraintsContext _context) {
            SNode factSelector = SNodeOperations.getNodeAncestor(_context.getContextNode(), CONCEPTS.FactSelector$4_, true, false);

            SNode classifier = SLinkOperations.getTarget(SLinkOperations.getTarget(SLinkOperations.getTarget(SLinkOperations.getTarget(factSelector, LINKS.fact$id2P), LINKS.target$Q83w), LINKS.type$kzl2), LINKS.classifier$cxMr);
            ...
            Iterable<SNode> getters = Sequence.fromIterable(IClassifier__BehaviorDescriptor.getSuperTypes_id6r77ob2URYj.invoke(classifier)).translate(new ITranslator2<SNode, SNode>() {
              ...
              public boolean accept(SNode it) {
                return SPropertyOperations.getString(SNodeOperations.cast(it, CONCEPTS.INamedConcept$Kd), PROPS.name$MnvL).startsWith("is") || SPropertyOperations.getString(SNodeOperations.cast(it, CONCEPTS.INamedConcept$Kd), PROPS.name$MnvL).startsWith("get");
              }
            });
  ...
  private static final SNodePointer breakingNode_75aht8_a0a0a0a0a1a0a0a0c = new SNodePointer("r:6d0c6b03-2136-4bce-ac04-5a6fc3e7f25b(Rules3.constraints)", "8484003412859920260");

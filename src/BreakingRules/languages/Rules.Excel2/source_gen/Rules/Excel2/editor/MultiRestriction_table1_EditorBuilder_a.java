...
/*package*/ class MultiRestriction_table1_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public MultiRestriction_table1_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_j3gktq_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    am_deleteRestictionMaintainGridPosition.setCellActions(editorCell, myNode, getEditorContext());
    if (nodeCondition_j3gktq_a0a()) {
      editorCell.addEditorCell(createConstant_0());
    }
    editorCell.addEditorCell(createRefNode_0());
    if (nodeCondition_j3gktq_a2a()) {
      editorCell.addEditorCell(createConstant_1());
    }
    editorCell.addEditorCell(createRefNode_1());
    if (nodeCondition_j3gktq_a4a()) {
      editorCell.addEditorCell(createConstant_2());
    }
    editorCell.addEditorCell(createRefNode_2());
    if (nodeCondition_j3gktq_a6a()) {
      editorCell.addEditorCell(createConstant_3());
    }
    return editorCell;
  }
  private boolean nodeCondition_j3gktq_a0a() {
  ...
  private boolean nodeCondition_j3gktq_a2a() {
    return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(myNode, LINKS.lhsrestriction$aVrh), CONCEPTS.MultiRestriction$y);
  }
  private boolean nodeCondition_j3gktq_a4a() {
  ...
  private boolean nodeCondition_j3gktq_a6a() {
    return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(myNode, LINKS.rhsrestriction$eztI), CONCEPTS.MultiRestriction$y);
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "(");
    editorCell.setCellId("Constant_j3gktq_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new lhsrestrictionSingleRoleHandler_j3gktq_b0(myNode, LINKS.lhsrestriction$aVrh, getEditorContext());
    return provider.createCell();
  }
  private static class lhsrestrictionSingleRoleHandler_j3gktq_b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public lhsrestrictionSingleRoleHandler_j3gktq_b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_j3gktq_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new operatorSingleRoleHandler_j3gktq_d0(myNode, LINKS.operator$dEUX, getEditorContext());
    return provider.createCell();
  }
  private static class operatorSingleRoleHandler_j3gktq_d0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public operatorSingleRoleHandler_j3gktq_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "(");
    editorCell.setCellId("Constant_j3gktq_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new rhsrestrictionSingleRoleHandler_j3gktq_f0(myNode, LINKS.rhsrestriction$eztI, getEditorContext());
    return provider.createCell();
  }
  private static class rhsrestrictionSingleRoleHandler_j3gktq_f0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public rhsrestrictionSingleRoleHandler_j3gktq_f0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_j3gktq_g0");
    editorCell.setDefaultText("");
    return editorCell;
  }

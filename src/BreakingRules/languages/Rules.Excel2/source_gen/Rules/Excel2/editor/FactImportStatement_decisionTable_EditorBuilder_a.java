...
/*package*/ class FactImportStatement_decisionTable_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FactImportStatement_decisionTable_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_fa2i19_a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeSingleRoleHandler_fa2i19_a0(myNode, LINKS.type$6tAj, getEditorContext());
    return provider.createCell();
  }
  private static class typeSingleRoleHandler_fa2i19_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeSingleRoleHandler_fa2i19_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {

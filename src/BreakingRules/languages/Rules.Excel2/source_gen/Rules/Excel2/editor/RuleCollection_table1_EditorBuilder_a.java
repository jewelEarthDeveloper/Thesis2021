...
/*package*/ class RuleCollection_table1_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RuleCollection_table1_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_au9phe_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_au9phe_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_au9phe_a0a");
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_au9phe_a1a(editorContext, node);
              ...
              editorCell.value.setCellId("Table_au9phe_b0");
  ...
  public Grid createChildsVertical_au9phe_a1a(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);


    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.rules$Bngn)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.rules$Bngn);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.rules$Bngn)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.rules$Bngn)).getElement(y) : null), LINKS.rules$Bngn);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.rules$Bngn)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.rules$Bngn, editorContext);
  ...
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_au9phe_a0_0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "rule group:");
    editorCell.setCellId("Constant_au9phe_a0a_0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_au9phe_c0a");
    editorCell.setDefaultText("");
    return editorCell;
  }

...
/*package*/ class FactImportedRef_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.target$C2kL;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.target$C2kL);
    }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createRefCell_1() {
      CellProviderWithRole provider = new RefCellCellProvider(myNode, LINKS.type$6tAj, CONCEPTS.ClassifierType$bL, "type", getEditorContext()) {

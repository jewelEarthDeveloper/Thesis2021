...
/*package*/ class InsertStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new factToInsertSingleRoleHandler_9dkotn_c0(myNode, LINKS.factToInsert$fMsH, getEditorContext());
  ...
  private static class factToInsertSingleRoleHandler_9dkotn_c0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.factToInsert$fMsH, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.factToInsert$fMsH, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.factToInsert$fMsH);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.factToInsert$fMsH));
      try {
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink factToInsert$fMsH = MetaAdapterFactory.getContainmentLink(0x17e7b90aaaca44c7L, 0xaaaa8155bb498bd7L, 0x7e19241b9e61c87eL, 0x7e19241b9e61c8d3L, "factToInsert");
  }
}

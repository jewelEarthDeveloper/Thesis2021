...
public final class StringLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x17e7b90aaaca44c7L, 0xaaaa8155bb498bd7L, 0x6ac2b99ff4c4085bL, "Rules2.structure.StringLiteral");
  ...
  /*package*/ static String toString_id6Y4UEk_yKFT(@NotNull SNode __thisNode__) {
    return "\"" + SPropertyOperations.getString(__thisNode__, PROPS.value$YOvi) + "\"";
  }

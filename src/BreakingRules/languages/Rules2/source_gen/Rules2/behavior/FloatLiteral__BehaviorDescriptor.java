...
public final class FloatLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x17e7b90aaaca44c7L, 0xaaaa8155bb498bd7L, 0x66cb70ed0d86ecc7L, "Rules2.structure.FloatLiteral");
  ...
  /*package*/ static String toString_id6Y4UEk_yKFT(@NotNull SNode __thisNode__) {
    return "" + SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.value$JBah), PROPS.value$ENN8);
  }

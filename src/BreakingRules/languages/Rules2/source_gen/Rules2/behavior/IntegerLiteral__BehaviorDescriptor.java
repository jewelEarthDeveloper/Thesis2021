...
public final class IntegerLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x17e7b90aaaca44c7L, 0xaaaa8155bb498bd7L, 0x7e19241b9ec822beL, "Rules2.structure.IntegerLiteral");
  ...
  /*package*/ static String toString_id6Y4UEk_yKFT(@NotNull SNode __thisNode__) {
    return "" + SPropertyOperations.getInteger(SLinkOperations.getTarget(__thisNode__, LINKS.value$Worh), PROPS.value$jgCM);
  }

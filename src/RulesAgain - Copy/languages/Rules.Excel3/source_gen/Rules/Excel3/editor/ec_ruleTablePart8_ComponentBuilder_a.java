...
/*package*/ class ec_ruleTablePart8_ComponentBuilder_a extends AbstractEditorBuilder {
  private static final Logger LOG = LogManager.getLogger(ec_ruleTablePart8_ComponentBuilder_a.class);
  @NotNull
      ...
      public void fillGrid(final ITableGrid grid, final SNode node, final SubstituteInfoFactory substituteInfoFactory) {
        ...
        for (SNode fact : Sequence.fromIterable(RuleCollection__BehaviorDescriptor.factsInCollection_id7mXf2twMdrP.invoke(rulesCollection))) {
          ...
          for (SNode prop : Sequence.fromIterable(RuleCollection__BehaviorDescriptor.propsFromFact_id4_O$GD8CABI.invoke(rulesCollection, fact))) {
            ...
            LoggingRuntime.logMsgView(Level.INFO, "col[" + colNr + "] " + SPropertyOperations.getString(prop, PROPS.name$MnvL), ec_ruleTablePart8_ComponentBuilder_a.class, null, null);
        ...
        for (int i = 0; i <= grid.getSizeX(); i++) {
          for (int j = 0; j <= grid.getSizeY(); j++) {
            ...
            LoggingRuntime.logMsgView(Level.INFO, "cell[" + i + "," + j + "] " + grid.getCell(i, j), ec_ruleTablePart8_ComponentBuilder_a.class, null, null);
            if ((createdNode == null)) {
              ...
              if (!((boolean) RuleCollection__BehaviorDescriptor.isVariableColumn_id5ER99ai_N5W.invoke(rulesCollection, ((int) i)))) {

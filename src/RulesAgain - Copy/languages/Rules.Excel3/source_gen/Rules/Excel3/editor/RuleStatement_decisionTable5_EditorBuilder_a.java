      ...
      public void fillGrid(final ITableGrid grid, final SNode node, final SubstituteInfoFactory substituteInfoFactory) {
        ...
        for (final SNode fact : Sequence.fromIterable(facts)) {
          ...
          if (Sequence.fromIterable(factsWithVars).contains(fact)) {
            ...
            grid.setCell(ColNr, 0, variable);
            if ((variable == null)) {
              grid.getCell(ColNr, 0).getStyle().set(StyleAttributes.getInstance().<Color>getAttribute("de.slisson.mps.tables", "shade-color"), Color.LIGHT_GRAY);
            }
          ...
          for (final SNode prop : Sequence.fromIterable(propsInFact)) {
            ...
            SNode restriction = SLinkOperations.getTarget(Sequence.fromIterable(constraints).first(), LINKS.restriction$jwYY);
            grid.setCell(ColNr, 0, restriction);
            if ((restriction == null)) {
              grid.getCell(ColNr, 0).getStyle().set(StyleAttributes.getInstance().<Color>getAttribute("de.slisson.mps.tables", "shade-color"), Color.LIGHT_GRAY);
            }

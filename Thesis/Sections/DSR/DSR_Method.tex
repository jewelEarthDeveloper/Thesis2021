...
\begin{figure}
    \centering
    \includegraphics[width=0.80\textwidth]{Sections/images/RSREditors_P.png} 
    \caption{Editors}
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{Sections/images/RSRSubstituteMenu_P.png}} 
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{Sections/images/RSRConstraint_P.png}}
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{Sections/images/RSRProgram_P.png}}
    \caption{RSD program}

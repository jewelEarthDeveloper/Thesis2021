...
The conditional, ``\texttt{when}'', or left-hand side (LHS) of the rule statement is a block of conditions which are subject to logical conjunctions. 
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{Sections/images/DroolsRule2.png}}

...
Thus, when we refer to ``developers'' in this paper, we mean users of the language that is the product of the metaprogramming. 
...
Modern IDEs, in the background, also parse the code it is displaying to create an AST that is uses to offer relevant coding assistance.
This assistance is useful.
...
Thus, multiple views of the model can be visible and updateable simultaneously.
...
This is achieved through the explicit knowledge of the language. 
...
This is especially true if the domain expertise of the developer is parser-based languages.
...
While there is no ambiguity in the code, there can be ambiguity in the mind of the reader.
This occurs as exactly the same notation can projected from different nodes.

...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{Sections/images/constraint_example.png}}
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.8075\textwidth]{Sections/images/typesystem_example.png}}
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.65\textwidth]{Sections/images/editor_example.png}}
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.85\textwidth]{Sections/images/intention_example.png}}

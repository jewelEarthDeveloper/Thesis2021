...
We followed Kitchenham's\cite{kitchenham2015evidence} advice on systematic review protocol validation to carry out this review.
...
This paper tries to answer the question "What is the current state of Projectional Editing?" with an SLR. 

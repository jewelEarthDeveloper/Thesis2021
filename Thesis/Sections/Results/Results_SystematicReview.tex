...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.45\textwidth]{/Sections/images/pie_study_type2.png}}
    \caption{Study types}
...
\begin{figure}
    ...
    \fbox{\begin{minipage}{0.5\textwidth}
            \centering
            \includegraphics[width=0.85\textwidth]{Sections/images/pie_projectional_publicvsresearch2.png}
            \caption{Public vs research}
            \label{fig:public_vs_research}
        \end{minipage}\hfill
        \begin{minipage}{0.5\textwidth}
            \centering
            \includegraphics[width=0.85\textwidth]{Sections/images/pie_projectional_publicprograms2.png} 
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{/Sections/images/sentiment_analysis3.png}}

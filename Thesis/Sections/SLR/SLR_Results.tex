...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{Sections/images/search_sankey-2.png}}
    \caption{SLR search and snowballing results}
...
Of these sentences, 435 were analysed as being positive, 1953 were neutral, and 615 were negative.
...
We will avoid rehashing the advantages and disadvantages of projectional editing, which come up again as we discussed these thoroughly in Section \ref{section:projectional_advantages} and Section \ref{section:projectional_disadvantages}.

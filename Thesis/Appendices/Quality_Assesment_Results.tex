...
After much research, we did not find a good checklist for ADR, so we used the case study checklist.
After concluding the quality assessment, we had to conclude that this checklist was not a valid interrogation of ADR studies or that all 20 ADR studies were poor.
